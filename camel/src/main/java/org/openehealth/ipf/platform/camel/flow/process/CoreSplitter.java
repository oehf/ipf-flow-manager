 ...
 */
public class CoreSplitter extends DelegateProcessor {
     ...
     */
    public CoreSplitter(Expression splitRule, Processor processor) {
        super(processor);
     ...
     */
    public CoreSplitter aggregate(AggregationStrategy strategy) {
        aggregationStrategy =
